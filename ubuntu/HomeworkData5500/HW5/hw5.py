...
#reads the code from the states text
with open("/home/ubuntu/HomeworkData5500/HW5/states_territories-1.txt") as f:
...
for state_code in state_codes:
    url = "https://api.covidtracking.com/v1/states/" + state_code + "/daily.json"
    #getting the data
    response = scraper.get(url)
    data = response.json()

    with open("/home/ubuntu/HomeworkData5500/HW5/" + state_code + ".json","w") as f: # opens a file on my computer and names it ut + json extension. It is in write mode so it creates or overides
